...
export default function QrDetail() {
    ...
    useEffect(() => {
        ...
        navigator.geolocation.getCurrentPosition((position) => {
            ...
            axios.get(`https://api.openweathermap.org/geo/1.0/reverse?lat=${position.coords.latitude}&lon=${position.coords.longitude}&limit=5&appid=6c77ffcc4e98194d877cee01a7e24315`)
                .then(d => {
            ...
            {loading ?
                ...
                data ?
                    <div className='flex flex-col w-full items-center justify-center'>
                        <p><b> {data?.points}</b> transfered to user account with the qr series no of
                            <b> {data?.series}</b>
                        </p>
                    </div>
                    :
