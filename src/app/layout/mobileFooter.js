  ...
  return (
    <div className="w-full h-[60px] fixed bottom-0 bg-[#f2f2f2] flex items-center justify-around ">
      ...
      >
        ...
        <small className="m-0 p-0 font-semibold">Rewards</small>
      </Link>
      ...
      >
        ...
        <small className="m-0 p-0 font-semibold">History</small>
      </Link>
      ...
      >
        ...
        <small className="m-0 p-0 font-semibold">Profile</small>
      </Link>
    </div>
  );
}
